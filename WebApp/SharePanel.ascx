            ...
            <form id="frmPrint" method="post" action="PrintableMap.ashx" target="print">
                ...
                <div class="frmField">
                    ...
                    <div class="frm_row topMargin">
                          <div class="frmLabel"></div>
                        <div class="frmField">
                          <span class="inlineCol">   <input type="radio" id="optPrintScaleInput" class="frmRadio" name="scalemode" value="input" /></span>
                            <span class="inlineCol"> <label id="labPrintScaleInput" for="optPrintScaleInput" >1" =</label></span>
                            <span class="inlineCol"> <input type="text" id="tboPrintScale" name="scale" class="frmInput ratting" placeholder="100" /></span>
