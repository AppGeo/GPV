...
<div id="pnlMarkupContent" class=" frm_box markup">
    ...
    <div class="frm_row customDrawTools">
        ...
        <button id="btnMarkupColor" class="btn frmBtn rightMargin btnLarge" title="Color of new markup">
            <span id="cmdMarkupColor" class="Button Color btnSquare"></span><span class="mrkpTxt">Color</span></button>
        ...
        <button id="btnTextGlowColor" class="btn frmBtn btnLarge" title="Glow color of new text">
            <span id="cmdTextGlowColor" class="Button Color btnSquare grey"></span><span class="mrkpTxt">Text Glow</span></button>
    ...
    <%--    <div class="frm_row">
        ...
        <div class="frmField">
            <button value="Search" id="btnShowCreateMarkup" class="btn frmBtn">Create Markup</button>
        </div>
    </div>--%>
    ...
    <div id="divMarkupSearch" class="hidden">
        ...
        <div class="frm_row topMargin">
            ...
            <div class="frmField">
                <input type="text" id="tboMarkupUser" runat="server" title="User Name" class="frmInput" /><br />
            </div>
        </div>
        <div class="frm_row">
            <div class="frmLabel">
        ...
        <div class="frm_row">
            ...
            <div class="frmField">
                ...
                <input type="text" id="tboMarkupTitle" class="frmInput" disabled="disabled" placeholder="Title" title="Title of the current markup group" /><br />
            </div>
        </div>
        <div class="frm_row">
            <div class="frmLabel">
            ...
            <div class="frmField">
                <textarea id="tboMarkupDetails" class="frmTextarea" title="Detail of the current markup group"></textarea>
