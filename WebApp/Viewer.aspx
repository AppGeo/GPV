          ...
          <div id="pnlFunctionSidebar" runat="server" class="Panel leftNav_panel ">
              <div class="inner">
                  <div class="topSection">
                      <div class="leftCol"><a id="btnHamburger" class="hamburger" href="#"></a>
                          <a id="btnHamburgerClose" class="hamburgerClose hidden " href="#"></a></div>
                  ...
                  <div class="leftLinks">
                      ...
                      <li id="tabMapTool" runat="server" class="MenuItem Normal" style="display:none">MapTool</li>
            ...
            <a id="logosmall" runat="server" class="VersionText" href="http://www.appgeo.com" target="AppGeo">AppGeo</a>
              ...
              <div class="">
                  <div id="pnlFunction" runat="server" class="left_details">
                      ...
                      <%--<div id="pnlMapTool" runat="server" class="FunctionPanel Panel" style="display: none">
                      <uc1:MapToolPanel ID="ucMapToolPanel" runat="server" />
                  </div>--%>
                  </div>
              </div>
          </div>
